...
const caseStudiesData: CaseStudy[] = [
  ...
  },
  {
    ...
    clientLogo: "/case-studies/global-education.png",
...
export default function CaseStudiesSection() {
  ...
  // Show only first 2 case studies on mobile, all 3 on desktop
  const displayedCaseStudies = isMobile ? caseStudiesData.slice(0, 2) : caseStudiesData;
  ...
  return (
    <section 
      className="py-8 sm:py-12 lg:py-16 bg-background relative overflow-hidden"
      aria-labelledby="case-studies-heading"
    >
      {/* Decorative shapes in top right corner - responsive sizing */}
      <div className="absolute top-0 right-0 pointer-events-none">
        {/* Semi-circle - smaller on mobile */}
        <div className="absolute -top-8 -right-8 sm:-top-12 sm:-right-12 lg:-top-16 lg:-right-16 w-16 h-16 sm:w-24 sm:h-24 lg:w-32 lg:h-32 bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-full"></div>
        {/* Triangle - smaller on mobile */}
        <div className="absolute top-4 right-4 sm:top-6 sm:right-6 lg:top-8 lg:right-8 w-0 h-0 border-l-[12px] border-l-transparent border-r-[12px] border-r-transparent border-b-[20px] border-b-blue-500/20 sm:border-l-[16px] sm:border-r-[16px] sm:border-b-[28px] lg:border-l-[20px] lg:border-r-[20px] lg:border-b-[35px]"></div>
        {/* Rectangle - smaller on mobile */}
        <div className="absolute top-12 right-12 sm:top-16 sm:right-16 lg:top-20 lg:right-20 w-8 h-6 sm:w-10 sm:h-7 lg:w-12 lg:h-8 bg-gradient-to-r from-purple-500/15 to-pink-500/15 rounded-sm transform rotate-12"></div>
      </div>
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        {/* Section Header with Navigation - responsive layout */}
        <div className="mb-8 sm:mb-10 lg:mb-12">
          {/* Title and Description */}
          <div className="mb-6 sm:mb-0">
            <h2 
              id="case-studies-heading"
              className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-3 sm:mb-4 leading-tight"
            >
          ...
          {/* Arrow Buttons - positioned differently on mobile */}
          <div className="flex items-center justify-center sm:justify-end gap-2 mt-6 sm:mt-0 sm:absolute sm:top-0 sm:right-0">
            <Button
              variant="outline"
              size="sm"
              onClick={handlePrevious}
              className="h-9 w-9 sm:h-10 sm:w-10 p-0 border-border hover:border-foreground hover:bg-muted"
